...
void URF_addUEdge(URF_graph *graph, URF_atom atom1, URF_atom atom2);
/*============================================================================*/
...
unsigned int URF_getWeight(URF_data *udata, int URF_id);
...
/** Returns the number of URFs that contain the bond consisting of the two given
 atoms */
unsigned int URF_numContainingBond(URF_data *udata, URF_atom atom1,
                                   URF_atom atom2);
...
unsigned int URF_getAtoms(URF_data *udata, unsigned int URF_id,
...
/** Gives the bonds of a URF identified with its index.
 ...
 connects. */
unsigned int URF_getBonds(URF_data *udata, unsigned int URF_id,
...
'free(*URF_ids_ptr)' */
unsigned int URF_listURFsWithAtom(URF_data *udata, unsigned int **URF_ids_ptr,
                                  URF_atom atom);
...
address as parameter)
 ...
 @note The array URF_ids_ptr has to be to be deallocated with
'free(*URF_ids_ptr)' */
unsigned int URF_listURFsWithBond(URF_data *udata, unsigned int **URF_ids_ptr,
...
unsigned int URF_getCycles(URF_data *udata, URF_cycle **URF_cycle_array_ptr,
                           unsigned int URF_id);
...
unsigned int URF_getBasis(URF_data *udata, URF_cycle **URF_cycle_array_ptr);
...
(declare 'URF_cycle *' and give address as parameter)
 ...
 @note Result has to be deallocated using
URF_deleteCycles(*URF_cycle_array_ptr, number). */
unsigned int URF_getRCPrototypes(URF_data *udata,
                                 URF_cycle **URF_cycle_array_ptr);
...
(declare 'URF_cycle *' and give address as parameter)
 ...
 @note Result has to be deallocated using
URF_deleteCycles(*URF_cycle_array_ptr, number). */
unsigned int URF_getRCycles(URF_data *udata, URF_cycle **URF_cycle_array_ptr);
...
'URF_getRCPrototypes()' and 'URF_getRCycles()' (arrays of URF_cycles) into an
...
deleted. */
unsigned int URF_translateCycArray(URF_data *udata, URF_cycle *old_array,
                                   unsigned int number,
...
(declare 'URF_bond *' and give address as parameter)
 ...
 Gives an array of bonds where a bond is represented by two URF_atoms that it
 connects. */
unsigned int URF_getEdgeArray(URF_data *udata, URF_bond **URF_bond_array_ptr);
