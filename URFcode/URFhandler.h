...
/** finds the index of the edge [from,to] in the graph. 'from' and 'to' can be URF_swapped for the same result. */
...
void URF_getPaths(int r, int p, char ***paths, int alloced, char mode, URF_graph *, sPathInfo *);
...
int URF_combinePaths(char ***paths1, char ***paths2, int p, int q, int x, char ***result, int currIdx, int alloced, char mode, URF_graph *);
