...
void giveVertices(int a, int b, char *array, URF_graph *, sPathInfo *);
...
void giveEdges(int a, int b, char *array, URF_graph *, sPathInfo *);
...
void getPaths(int r, int p, char ***paths, int alloced, char mode, URF_graph *, sPathInfo *);
...
int combinePaths(char ***paths1, char ***paths2, int p, int q, int x, char ***result, int currIdx, int alloced, char mode, URF_graph *);
