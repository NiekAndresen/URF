...
typedef struct{
    ...
    URF_graph **dPaths; /*for each vertex: a subgraph of the original graph that stores the shortest paths back to the vertex (in Vismara: U_r).Useful to find paths/edges of a RCF.*/
}sPathInfo;
